...
export const Button = React.forwardRef<HTMLButtonElement, ButtonProps>(
  ({ 
    ...
    const baseStyles = 'inline-flex items-center justify-center font-medium transition-all duration-normal focus:outline-none focus:ring-2 focus:ring-offset-0 disabled:cursor-not-allowed disabled:opacity-50';
...
export const IconButton = React.forwardRef<HTMLButtonElement, IconButtonProps>(
  ({ 
    ...
    const baseStyles = 'inline-flex items-center justify-center transition-all duration-normal focus:outline-none focus:ring-2 focus:ring-offset-0 disabled:cursor-not-allowed disabled:opacity-50';
